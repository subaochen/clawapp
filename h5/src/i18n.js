...
const messages = {
  'zh-CN': {
    ...
    // 语音唤醒
    'voice.wakeup.title': '语音唤醒',
    'voice.wakeup.enable': '开启语音唤醒',
    'voice.wakeup.word': '唤醒词',
    'voice.wakeup.word.placeholder': '例如：你好助手',
    'voice.wakeup.ending': '结束语',
    'voice.wakeup.ending.placeholder': '例如：说完了',
    'voice.wakeup.ending.hint': '说完后自动发送，不包含结束语本身',
    'voice.wakeup.permission.denied': '麦克风权限被拒绝，请在浏览器设置中允许',
    'voice.wakeup.network.error': '语音识别网络错误，请检查网络连接',
    'voice.wakeup.error': '语音唤醒错误',
    'voice.wakeup.listening': '正在监听唤醒词...',
    'voice.wakeup.woken': '已唤醒，请说话',
    'voice.wakeup.submitting': '正在发送...',
    'voice.auto.submit': '自动提交',
    'media.file': '文件',
    'media.download': '下载',
  ...
  'en': {
    ...
    // Voice Wakeup
    'voice.wakeup.title': 'Voice Wakeup',
    'voice.wakeup.enable': 'Enable Voice Wakeup',
    'voice.wakeup.word': 'Wakeup Word',
    'voice.wakeup.word.placeholder': 'e.g. Hello Assistant',
    'voice.wakeup.ending': 'Ending Word',
    'voice.wakeup.ending.placeholder': 'e.g. That\'s all',
    'voice.wakeup.ending.hint': 'Auto-send after ending word (excluding the ending word itself)',
    'voice.wakeup.permission.denied': 'Microphone permission denied. Please allow in browser settings.',
    'voice.wakeup.network.error': 'Voice recognition network error. Please check your connection.',
    'voice.wakeup.error': 'Voice wakeup error',
    'voice.wakeup.listening': 'Listening for wakeup word...',
    'voice.wakeup.woken': 'Woken up. Please speak.',
    'voice.wakeup.submitting': 'Sending...',
    'voice.auto.submit': 'Auto Submit',
    // Notifications
